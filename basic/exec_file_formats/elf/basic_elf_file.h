...
struct basic_elf_file {
    ...
    section *get_section_at_index_from_table(size_t index) const {
        return reinterpret_cast<section *>(raw_file->offset_in_file(offset_of_sections_table() + sz_of_section_table_entry() * index));
    }
    ...
    segment *get_program_header_at_index_from_table(size_t index) const {
        return reinterpret_cast<segment *>(raw_file->offset_in_file(offset_of_program_headrs_table() + sz_of_program_header_table_entry() * index));
    }
